<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AramaMotoru.aspx.cs" Inherits="InternetProgramciligi2.AramaMotoru"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- BUTTON AND SEARCH TEXT --> 
    </br>
    <asp:TextBox ID="TextBox1" runat="server" TextMode="Search"></asp:TextBox>
    <asp:Button ID="Ara" runat="server" Text="Ara" OnClick="ARA_Click" />
    </br>
    </br>
