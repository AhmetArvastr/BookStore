...
{
    public partial class AramaMotoru : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataSource1.SelectCommand = "select b.ID,b.Title,b.Image,b.Price,a.Name,a.Country,a.Image from Books as b inner join KitaplarYazarlar as k on b.ID=k.BookID inner join Authors as a on a.ID=k.AuthorID where b.Title like'%" + arama + "%' or a.Name like'%" + arama + "%'";
            
            //GRIDVIEW VISIBLE PARAMETERS
        ...
        protected void ARA_Click(object sender, EventArgs e)
        {
                ...
                SqlDataSource1.SelectCommand = "select b.ID,b.Title,b.Image,b.Price,a.Name,a.Country,a.Image from Books as b inner join KitaplarYazarlar as k on b.ID=k.BookID inner join Authors as a on a.ID=k.AuthorID where b.Title like'%" + TextBox1.Text + "%' or a.Name like'%" + TextBox1.Text + "%'";
